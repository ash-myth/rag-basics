        ...
        [
            SystemMessage(
                content=(
                    ...
                    "and answer questions about AI/ML concepts(REFER TO THE SEARCH DOCS TOOL GIVEN. IF NOT FOUND GIVE A SHORT EXPLANATION AND SAY IT WAS NOT PRESENT IN THE DOCS). "
                    "Use the search_docs tool when the user asks about AI, ML, or related topics like"
                    "LangGraph, RAG, embeddings, transformers, or related topics. "
                    "Use the math tools for calculations."
                    "Do not answer anything extra. Your job is just limited to calculation and ML related answers."
                )
            )
        ]
        + state["messages"]
